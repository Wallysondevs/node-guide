export default function ProcessInfo() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>O objeto <code>process</code> expõe metadados úteis sobre o processo Node em execução: identificador, diretório, plataforma, versões e uso de recursos. Essencial para logs, diagnóstico e métricas.</p>
...
<div class="callout callout-info"><div class="callout-title">Limites de heap</div><div>O default do V8 é ~1.7GB em 64-bit. Suba com <code>node --max-old-space-size=4096</code> (em MB). Se você precisa disso, talvez seja hora de streamar dados em vez de carregar tudo em memória.</div></div>`}} />
    </article>
  );
}
