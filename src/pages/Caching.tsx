export default function Caching() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Cachear evita repetir trabalho caro: query lenta, chamada externa, render de template. As duas camadas mais comuns em Node são <strong>in-memory</strong> (rápido, local ao processo) e <strong>Redis</strong> (compartilhado, persistente).</p>
...
<div class="callout callout-warn"><div class="callout-title">Negative caching</div><div>Cachear "não encontrado" evita repetir 404s caros. Mas TTL curto, senão dados novos ficam invisíveis.</div></div>`}} />
    </article>
  );
}
