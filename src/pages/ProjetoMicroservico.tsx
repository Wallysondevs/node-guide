export default function ProjetoMicroservico() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Microserviço de pedidos com <strong>Fastify</strong> + <strong>RabbitMQ</strong> + <strong>Postgres</strong>, logs estruturados (Pino), healthcheck, graceful shutdown e publicação assíncrona via fila para um worker desacoplado.</p>
...
<div class="callout callout-tip"><div class="callout-title">Observabilidade</div><div>Adicione OpenTelemetry e exporte traces para Jaeger/Tempo. Cada serviço propaga <code>traceparent</code> via headers HTTP e propriedades AMQP.</div></div>`}} />
    </article>
  );
}
