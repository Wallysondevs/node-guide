...
<div class="callout callout-tip"><div class="callout-title">events.once</div><div>Use <code>const [data] = await once(emitter, 'data')</code> para promisificar — ele já trata <code>'error'</code> rejeitando a promise.</div></div>`}} />
    </article>
  );
}
