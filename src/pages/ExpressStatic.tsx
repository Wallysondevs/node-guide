export default function ExpressStatic() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Express · iniciante · 9 min</div>
      <h1>Static files e uploads</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Express serve arquivos estáticos via <code>express.static</code> (built-in, baseado em <code>serve-static</code>) e recebe uploads via <code>multer</code>. Para tráfego pesado, prefira CDN ou nginx — mas em dev ou cargas leves, ambos resolvem.</p>
...
<div class="callout callout-tip"><div class="callout-title">Alternativas robustas</div><div>Para uploads grandes (vídeos), use <code>tus-node-server</code> (resumable) ou pre-signed URLs do S3 — o cliente envia direto, sem passar pelo Express.</div></div>`}} />
    </article>
  );
}
