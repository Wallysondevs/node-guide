export default function Pipeline() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p><code>pipeline</code> conecta streams e gerencia erros, fechamento e backpressure automaticamente. Em código moderno, <strong>sempre</strong> prefira <code>pipeline</code> ao <code>.pipe()</code> manual.</p>
...
<div class="callout callout-warn"><div class="callout-title">.pipe() vaza</div><div><code>.pipe()</code> manual não propaga erros corretamente nem fecha streams downstream em caso de erro upstream. É a causa #1 de file descriptor leaks em servidores Node antigos.</div></div>`}} />
    </article>
  );
}
