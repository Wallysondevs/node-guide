export default function ReadableStream() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Um <strong>Readable</strong> é uma fonte de dados que entrega chunks em vez de tudo de uma vez. Permite processar arquivos enormes, respostas HTTP e pipes de processo sem estourar memória.</p>
...
<div class="callout callout-tip"><div class="callout-title">Web Streams interop</div><div>Desde o Node 18, converta com <code>Readable.toWeb(node)</code> e <code>Readable.fromWeb(web)</code>. Útil para usar <code>fetch().body</code> dentro de pipelines Node.</div></div>`}} />
    </article>
  );
}
