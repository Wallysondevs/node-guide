export default function DestructuringSpread() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Destructuring e spread/rest são sintaxes de ES2015+ que dominam o código JS/Node moderno. Servem para extrair partes de objetos/arrays, copiar coleções e definir argumentos opcionais de forma legível.</p>
...
<div class="callout callout-tip"><div class="callout-title">Tipagem em TS</div><div>O TS infere o tipo do <code>...rest</code> como <code>Omit&lt;T, K&gt;</code> automaticamente — útil para criar funções <code>publicUser</code> tipadas.</div></div>`}} />
    </article>
  );
}
