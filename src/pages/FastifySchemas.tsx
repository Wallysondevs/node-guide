export default function FastifySchemas() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Schemas são o coração do Fastify: validam entradas, serializam saídas e geram documentação. Você descreve os contratos uma única vez e ganha validação, performance e tipos.</p>
...
<div class="callout callout-warn"><div class="callout-title">Zod no Fastify</div><div>Para usar Zod direto, instale <code>fastify-type-provider-zod</code>. Ele converte o schema Zod em JSON Schema por baixo dos panos.</div></div>`}} />
    </article>
  );
}
