export default function ExpressSetup() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>Express: setup</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Express continua sendo o framework HTTP mais popular do Node. É minimalista — você compõe a aplicação somando middlewares — e tem ecossistema imenso. Esta página mostra um setup limpo e production-ready.</p>
...
<div class="callout callout-tip"><div class="callout-title">Hot reload</div><div><code>tsx watch</code> (ou <code>node --watch</code> a partir do 20) recarrega o servidor a cada save sem precisar de nodemon.</div></div>`}} />
    </article>
  );
}
