export default function ProjetoApiCrud() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Vamos construir uma API REST de blog com autenticação JWT, validação Zod, persistência em Postgres via Prisma, hashing de senha com bcrypt e tratamento de erros centralizado. Stack idiomática para produção em Node 20+.</p>
...
<div class="callout callout-tip"><div class="callout-title">Próximos passos</div><div>Adicione testes com <code>supertest</code>, OpenAPI com <code>zod-to-openapi</code>, e CI com migrate em ambiente efêmero.</div></div>`}} />
    </article>
  );
}
