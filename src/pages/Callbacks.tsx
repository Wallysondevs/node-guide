export default function Callbacks() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>Callbacks</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Callbacks são a forma mais antiga de assincronia em Node: você passa uma função que será chamada quando a operação terminar. A convenção <strong>error-first</strong> (<code>(err, result) =&gt; ...</code>) padronizou o modelo e ainda permeia APIs nativas e bibliotecas legadas.</p>
...
<div class="callout callout-tip"><div class="callout-title">util.callbackify</div><div>Inverso do <code>promisify</code>: transforma uma função async em callback. Útil para integrar código novo com libs antigas.</div></div>`}} />
    </article>
  );
}
