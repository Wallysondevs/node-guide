export default function Tsup() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Build & TS · intermediario · 6 min</div>
      <h1>tsup</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>tsup</strong> é um wrapper amigável sobre o esbuild focado em <em>publicar libraries</em>. Em um comando você gera ESM + CJS + tipos <code>.d.ts</code>, com tree-shaking, watch e dual package — sem mexer em config de Rollup.</p>
...
<div class="callout callout-tip"><div class="callout-title">Cuidado com dual package hazard</div><div>Quando ESM e CJS coexistem, instâncias podem divergir (duas cópias do mesmo módulo). Evite estado global em libs dual; use <code>"type": "module"</code> e ESM-only quando possível.</div></div>`}} />
    </article>
  );
}
