export default function ProcessExit() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">process/env · intermediario · 8 min</div>
      <h1>Exit codes e signals</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Em produção, processos Node são monitorados pelo SO ou orquestrador. Exit codes corretos e graceful shutdown são <strong>essenciais</strong> para CI, healthchecks, e zero-downtime deploy.</p>
...
<div class="callout callout-tip"><div class="callout-title">Healthcheck</div><div>Durante shutdown, retorne 503 no endpoint de readiness para o load balancer parar de mandar tráfego antes mesmo do close.</div></div>`}} />
    </article>
  );
}
