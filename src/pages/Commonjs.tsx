export default function Commonjs() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Módulos · iniciante · 8 min</div>
      <h1>CommonJS (require)</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>CommonJS (CJS) é o sistema de módulos histórico do Node, ainda dominante em milhões de pacotes. Usa <code>require()</code> síncrono e <code>module.exports</code>. Conhecer CJS é obrigatório mesmo em projetos novos ESM — você inevitavelmente integra com libs CJS.</p>
...
<div class="callout callout-tip"><div class="callout-title">Transição</div><div>Adote <code>"type": "module"</code> em projetos novos. Quando precisar de CJS pontual, renomeie para <code>.cjs</code>.</div></div>`}} />
    </article>
  );
}
