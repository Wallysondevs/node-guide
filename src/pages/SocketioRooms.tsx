export default function SocketioRooms() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Realtime · intermediario · 7 min</div>
      <h1>Rooms e namespaces</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>Rooms</strong> e <strong>namespaces</strong> são os dois mecanismos do Socket.IO para segmentar conexões. Confundi-los gera mensagens entregues a quem não deveria — bug clássico em chats e dashboards.</p>
...
<div class="callout callout-tip"><div class="callout-title">Namespaces, não rooms, para auth</div><div>Se a separação é por permissão fixa (admin vs user), prefira namespaces com middleware. Se é por escopo dinâmico (sala de chat X), use rooms.</div></div>`}} />
    </article>
  );
}
