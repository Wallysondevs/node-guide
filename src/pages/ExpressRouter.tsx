export default function ExpressRouter() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p><code>express.Router()</code> cria mini-aplicações independentes que podem ter rotas, middlewares e error handlers próprios. É a forma idiomática de organizar APIs grandes em arquivos por recurso.</p>
...
<div class="callout callout-tip"><div class="callout-title">Auto-loader</div><div>Em projetos grandes, use <code>fs.readdir</code> ou <code>fast-glob</code> para montar todos os arquivos de <code>routes/</code> automaticamente, evitando esquecer de importar.</div></div>`}} />
    </article>
  );
}
