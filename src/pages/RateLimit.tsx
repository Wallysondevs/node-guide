export default function RateLimit() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>Rate limiting</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>Rate limiting</strong> protege APIs contra abuso, força bruta, scraping e custos descontrolados, limitando quantas requisições um cliente pode fazer em uma janela de tempo. É fundamental em qualquer endpoint público.</p>
...
<div class="callout callout-tip"><div class="callout-title">Throttle inteligente</div><div>Para login, combine <code>express-slow-down</code> (atrasa progressivamente) com <code>express-rate-limit</code> (bloqueia depois). Frustra ataques sem irritar usuários.</div></div>`}} />
    </article>
  );
}
