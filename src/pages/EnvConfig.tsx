export default function EnvConfig() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>O princípio do <em>12-factor</em> diz: <strong>config vive no ambiente, não no código</strong>. Em Node isso vira ler <code>process.env</code>, validar no startup e expor um objeto tipado para o resto da aplicação.</p>
...
<div class="callout callout-warn"><div class="callout-title">Cuidado com logs</div><div>Nunca logue o objeto <code>env</code> inteiro — segredos vão aparecer no console e no agregador de logs. Logue só chaves não sensíveis ou um diff redacted.</div></div>`}} />
    </article>
  );
}
