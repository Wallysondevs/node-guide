export default function ProjetoChat() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Projetos · intermediario · 12 min</div>
      <h1>Projeto: chat realtime</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Chat em tempo real com salas, presença e histórico, usando <strong>Socket.IO</strong> sobre Express e Redis como adapter para escalar horizontalmente. Persistência simples em SQLite via better-sqlite3.</p>
...
<div class="callout callout-tip"><div class="callout-title">Autenticação</div><div>Passe um JWT em <code>io({ auth: { token } })</code> e valide em <code>io.use((socket, next) =&gt; ...)</code> antes de aceitar a conexão.</div></div>`}} />
    </article>
  );
}
