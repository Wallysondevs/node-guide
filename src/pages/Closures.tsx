export default function Closures() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>Closures</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Uma <strong>closure</strong> é uma função que "lembra" o escopo léxico onde foi criada — mesmo depois de esse escopo terminar. É a base de encapsulamento, currying, factories e callbacks idiomáticos em JS.</p>
...
<div class="callout callout-tip"><div class="callout-title">WeakMap para identidade</div><div>Para anexar dados privados a objetos sem leak, combine closure com <code>WeakMap</code> — o GC limpa quando a chave some.</div></div>`}} />
    </article>
  );
}
