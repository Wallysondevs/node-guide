export default function Transform() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Um <strong>Transform</strong> é simultaneamente Readable e Writable: você escreve chunks de um lado e lê (transformados) do outro. Compressão, criptografia, parsing CSV, tradução de encoding — tudo é Transform.</p>
...
<div class="callout callout-tip"><div class="callout-title">Generators vs classes</div><div>Para transforms simples e ad-hoc, async generators dentro de <code>pipeline</code> são mais limpos. Para componentes reutilizáveis com configuração, classe Transform tem cara mais profissional.</div></div>`}} />
    </article>
  );
}
