...
<div class="callout callout-warn"><div class="callout-title">Overhead</div><div>Profiling pode dobrar latência. Os números absolutos não são representativos; o que importa é o formato do gráfico e onde está o pico.</div></div>`}} />
    </article>
  );
}
