export default function ProjectReferences() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Build & TS · avancado · 8 min</div>
      <h1>Project references</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>Project references</strong> permitem dividir um codebase TypeScript grande em vários projetos menores, com builds incrementais, paralelos e isolados. Essencial em monorepos onde libs internas dependem umas das outras.</p>
...
<div class="callout callout-tip"><div class="callout-title">Combine com pnpm workspaces</div><div>Em <code>package.json</code> de cada lib, aponte <code>"main": "dist/index.js"</code> e <code>"types": "dist/index.d.ts"</code>. O resolver do Node achará tudo via <code>workspace:*</code>.</div></div>`}} />
    </article>
  );
}
