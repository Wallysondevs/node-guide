export default function Promises() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Async · iniciante · 10 min</div>
      <h1>Promises</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Uma <strong>Promise</strong> representa o resultado futuro de uma operação assíncrona. Ela substituiu callbacks aninhados (callback hell) e é a base de <code>async/await</code> no Node moderno.</p>
...
<div class="callout callout-tip"><div class="callout-title">Prefira async/await</div><div>Em código novo, use <code>async/await</code> — é mais legível e o stack trace fica completo. Reserve <code>.then</code> para encadeamentos pontuais ou estilo funcional.</div></div>`}} />
    </article>
  );
}
