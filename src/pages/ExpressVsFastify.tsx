export default function ExpressVsFastify() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Express e Fastify são os dois frameworks HTTP mais usados em Node. Ambos são minimalistas, mas têm filosofias diferentes em torno de performance, validação e ecossistema. Saber quando escolher cada um é parte do trabalho de um dev backend Node.</p>
...
<div class="callout callout-tip"><div class="callout-title">Migração</div><div>Migrar de Express para Fastify costuma valer a pena quando você quer schemas como contrato e logs estruturados de fábrica (pino).</div></div>`}} />
    </article>
  );
}
