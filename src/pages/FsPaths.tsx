...
<div class="callout callout-tip"><div class="callout-title">URLs ≠ paths</div><div>Para URLs use <code>new URL(rel, base)</code>. Para paths de arquivo, <code>path</code>. Misturar gera bugs no Windows porque o construtor de URL exige <code>/</code>.</div></div>`}} />
    </article>
  );
}
