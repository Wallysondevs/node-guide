export default function EventEmitter() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Eventos · iniciante · 8 min</div>
      <h1>EventEmitter</h1>
      <div dangerouslySetInnerHTML={{__html: `<p><strong>EventEmitter</strong> é o padrão pub/sub embutido no Node. Quase tudo no core o estende: <code>http.Server</code>, streams, <code>process</code>, sockets, child processes. Entender a API é entender como o Node se comunica internamente.</p>
...
<div class="callout callout-tip"><div class="callout-title">eventemitter3</div><div>Para apps onde o overhead do core <code>events</code> importa (alta frequência), o pacote <code>eventemitter3</code> é uma alternativa drop-in, ~3x mais rápida.</div></div>`}} />
    </article>
  );
}
