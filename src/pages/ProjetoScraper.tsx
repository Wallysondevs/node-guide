export default function ProjetoScraper() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Projetos · intermediario · 11 min</div>
      <h1>Projeto: web scraper</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Scraper que faz crawl de um site, extrai títulos/links com <strong>cheerio</strong>, respeita <code>robots.txt</code>, controla concorrência com <code>p-limit</code>, persiste em SQLite e suporta retomada após falha.</p>
...
<div class="callout callout-tip"><div class="callout-title">Escala</div><div>Para milhões de URLs, troque o loop por uma fila distribuída (BullMQ/Redis) e múltiplos workers em containers.</div></div>`}} />
    </article>
  );
}
