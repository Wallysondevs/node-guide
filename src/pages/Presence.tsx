export default function Presence() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Mostrar quem está online é um problema clássico de realtime: precisa rastrear conexões, lidar com múltiplas abas, sobreviver a reconexões e — em produção — funcionar entre múltiplas instâncias do servidor.</p>
...
<div class="callout callout-tip"><div class="callout-title">Debounce offline</div><div>Antes de emitir <code>online: false</code>, espere 5–10s e cheque de novo. Reduz "piscar" do indicador em redes ruins.</div></div>`}} />
    </article>
  );
}
