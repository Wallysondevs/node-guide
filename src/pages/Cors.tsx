...
<div class="callout callout-tip"><div class="callout-title">Debug rápido</div><div>Use <code>curl -i -X OPTIONS https://api/... -H 'Origin: https://app...' -H 'Access-Control-Request-Method: POST'</code> para inspecionar a resposta de preflight sem o navegador.</div></div>`}} />
    </article>
  );
}
