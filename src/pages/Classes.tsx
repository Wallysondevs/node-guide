export default function Classes() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Classes em JS são açúcar sintático sobre o sistema de protótipos. Desde ES2022 o conjunto ficou completo: campos públicos/privados, métodos estáticos, getters/setters, herança e <code>static blocks</code> de inicialização.</p>
...
<div class="callout callout-tip"><div class="callout-title">instanceof e Symbol.hasInstance</div><div>Você pode customizar <code>instanceof</code> implementando <code>static [Symbol.hasInstance](obj)</code> — útil para checks estruturais.</div></div>`}} />
    </article>
  );
}
