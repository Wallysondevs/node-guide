export default function Funcoes() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Funções são cidadãs de primeira classe em JS: você passa, retorna e armazena. Em Node, escolher entre <code>function</code>, expressão e arrow afeta hoisting, <code>this</code>, e legibilidade de stack traces.</p>
...
<div class="callout callout-info"><div class="callout-title">Tail call</div><div>Node não otimiza tail calls (TCO). Para recursão profunda, use loop ou trampolim.</div></div>`}} />
    </article>
  );
}
