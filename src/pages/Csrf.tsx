...
<div class="callout callout-tip"><div class="callout-title">Prefira Bearer</div><div>Em arquiteturas novas (SPA + API), use JWT/opaco em <code>Authorization: Bearer</code>. Elimina toda a classe de ataques CSRF.</div></div>`}} />
    </article>
  );
}
