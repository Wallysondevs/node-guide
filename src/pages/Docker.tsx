export default function Docker() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Deploy · intermediario · 10 min</div>
      <h1>Dockerizando Node</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Containerizar uma app Node serve para garantir paridade entre dev/staging/prod, simplificar deploy (Kubernetes, ECS, Fly.io) e isolar dependências de SO. Imagens bem-feitas pesam &lt; 150 MB e bootam em segundos.</p>
...
<div class="callout callout-tip"><div class="callout-title">Imagens menores</div><div>Use <code>node:20-alpine</code> (~50 MB) ou imagens <code>distroless</code>. Para apps com binários nativos (<code>sharp</code>, <code>node-canvas</code>), pode ser preciso usar <code>node:20-slim</code>.</div></div>`}} />
    </article>
  );
}
