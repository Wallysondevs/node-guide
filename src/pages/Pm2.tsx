export default function Pm2() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <h1>PM2</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>PM2 é um <strong>process manager</strong> para Node em servidores tradicionais (VPS, bare-metal). Ele garante restart automático em crash, modo cluster (1 processo por core), logs centralizados e zero-downtime reload.</p>
...
<div class="callout callout-warn"><div class="callout-title">Contêineres</div><div>Em container, rode <code>node dist/server.js</code> direto como PID 1. Use <code>tini</code> ou <code>--init</code> do Docker para receber sinais corretamente.</div></div>`}} />
    </article>
  );
}
