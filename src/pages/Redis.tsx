export default function Redis() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Redis é um armazenamento chave-valor em memória, ultrarrápido, com tipos de dados ricos (strings, listas, sets, hashes, streams, sorted sets). Usado para cache, sessões, rate limit, pub/sub, filas leves e leaderboards.</p>
...
<div class="callout callout-tip"><div class="callout-title">Conexão única em serverless</div><div>Em Lambda/Edge, reaproveite a conexão entre invocações guardando-a fora do handler. Cada cold start abre socket novo — caro no p99.</div></div>`}} />
    </article>
  );
}
