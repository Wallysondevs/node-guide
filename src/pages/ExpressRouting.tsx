export default function ExpressRouting() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Express · iniciante · 10 min</div>
      <h1>Roteamento e parâmetros</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Roteamento em Express é o casamento entre método HTTP e path. Cada combinação aponta para uma cadeia de middlewares terminando num handler. Saber como params, query e body diferem é o primeiro passo para APIs RESTful sólidas.</p>
...
<div class="callout callout-tip"><div class="callout-title">Express 5</div><div>Sintaxe de wildcards e opcionais mudou (path-to-regexp v6). Veja o <em>migration guide</em> antes de subir o major.</div></div>`}} />
    </article>
  );
}
