export default function Encoding() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Streams &amp; Buffers · iniciante · 7 min</div>
      <h1>Encodings</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Encoding é o mapeamento entre <strong>bytes</strong> (o que circula em arquivos, sockets, buffers) e <strong>caracteres</strong> (o que humanos leem). Confundir os dois é causa #1 de bugs com acentos, emojis e dados binários corrompidos.</p>
...
<div class="callout callout-tip"><div class="callout-title">Detectando encoding</div><div>Use o pacote <code>chardet</code> ou <code>jschardet</code> para adivinhar encoding de arquivos legados. Em CSVs do Excel, geralmente é <code>windows-1252</code>.</div></div>`}} />
    </article>
  );
}
