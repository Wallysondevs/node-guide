export default function HelmetCsrf() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Três camadas de defesa para apps com sessão por cookie: <strong>Helmet</strong> seta headers de segurança, <strong>CSRF tokens</strong> impedem POST forjados de outros sites, e <strong>cookies seguros</strong> evitam roubo de sessão por XSS ou redes inseguras.</p>
...
<div class="callout callout-tip"><div class="callout-title">Prefixos de cookie</div><div><code>__Host-</code> exige Secure, Path=/ e sem Domain. <code>__Secure-</code> exige Secure. Browsers rejeitam variantes inseguras.</div></div>`}} />
    </article>
  );
}
