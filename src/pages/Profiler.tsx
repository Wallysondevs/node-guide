export default function Profiler() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      <div className="text-xs text-muted-foreground mb-2 font-mono">Performance · intermediario · 8 min</div>
      <h1>Profiler embutido</h1>
      <div dangerouslySetInnerHTML={{__html: `<p>Antes de chutar otimizações, <strong>meça</strong>. Node traz três ferramentas de profiling embutidas: o sampling profiler (<code>--prof</code>), o inspector com Chrome DevTools (<code>--inspect</code>) e a API <code>perf_hooks</code> para instrumentação manual.</p>
...
<div class="callout callout-tip"><div class="callout-title">Ferramentas amigáveis</div><div>Para análise visual sem DevTools, use <strong>clinic.js</strong> (clinic doctor/flame/bubbleprof) — é um wrapper sobre essas mesmas APIs com UI HTML pronta.</div></div>`}} />
    </article>
  );
}
