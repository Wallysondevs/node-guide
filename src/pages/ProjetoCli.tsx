export default function ProjetoCli() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>Construímos um CLI <strong>myctl</strong> com subcomandos, flags, spinner, cores e prompts interativos. Stack: <code>commander</code>, <code>chalk</code>, <code>ora</code>, <code>prompts</code>. Distribuído via <code>npm publish</code> com <code>bin</code>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Empacote único</div><div>Use <code>esbuild --bundle --platform=node</code> ou <code>pkg</code> para distribuir um binário único sem exigir Node instalado no usuário.</div></div>`}} />
    </article>
  );
}
