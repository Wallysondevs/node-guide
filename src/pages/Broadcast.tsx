export default function Broadcast() {
  return (
    <article className="chapter max-w-3xl mx-auto px-6 py-10">
      ...
      <div dangerouslySetInnerHTML={{__html: `<p>"Broadcast" em sistemas realtime é enviar a mesma mensagem para múltiplos clientes ao mesmo tempo. No Socket.IO, controle quem recebe via <em>rooms</em>, <em>namespaces</em> e operadores como <code>broadcast</code>, <code>to</code> e <code>except</code>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Ack confirmações</div><div><code>socket.emit('msg', data, (resp) =&gt; { ... })</code> recebe ack do cliente — útil pra confirmar entrega.</div></div>`}} />
    </article>
  );
}
