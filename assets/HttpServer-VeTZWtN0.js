import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function a(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"HTTP nativo · intermediario · 9 min"}),e.jsx("h1",{children:"Servidor HTTP cru"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Antes de usar Express ou Fastify, vale entender o módulo <code>node:http</code>: é a base sobre a qual todo framework é construído. Em microsserviços simples, ele basta — sem dependências, sem overhead.</p>
...
<div class="callout callout-tip"><div class="callout-title">close vs closeAllConnections</div><div>Em graceful shutdown, <code>server.close()</code> espera conexões existentes. <code>closeAllConnections()</code> (Node 18+) força fechamento.</div></div>`}})]})}export{a as default};
