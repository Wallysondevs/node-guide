import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"fs · intermediario · 7 min"}),e.jsx("h1",{children:"fs.watch e --watch"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Observar mudanças em arquivos é a base de hot reload, sync de configs e build watchers. O Node oferece duas APIs nativas (<code>fs.watch</code> e <code>fs.watchFile</code>) e a flag de runtime <code>--watch</code>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Em produção: não use</div><div>Watchers são para desenvolvimento. Em prod, prefira sinais (<code>SIGHUP</code> para reload de config) ou um endpoint de admin.</div></div>`}})]})}export{i as default};
