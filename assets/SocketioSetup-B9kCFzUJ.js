import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Realtime · intermediario · 8 min"}),e.jsx("h1",{children:"Socket.IO: setup"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Socket.IO é uma camada acima do WebSocket que adiciona reconexão automática, fallback para HTTP long-polling, rooms, namespaces, broadcast e ack/timeout. É a forma mais pragmática de fazer realtime em Node hoje.</p>
...
<div class="callout callout-warn"><div class="callout-title">Sticky sessions obrigatórias</div><div>O handshake inicial pode usar HTTP polling. Se o LB roteia cada request para um pod diferente, a conexão nunca completa. Configure <code>ip_hash</code> no NGINX ou cookie-based no ALB.</div></div>`}})]})}export{r as default};
