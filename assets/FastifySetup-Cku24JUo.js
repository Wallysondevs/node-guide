import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Fastify · intermediario · 7 min"}),e.jsx("h1",{children:"Fastify: setup"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Subir um servidor Fastify leva poucos segundos, mas montar um esqueleto sólido — com logger, env tipado, graceful shutdown e organização de plugins — é o que diferencia um POC de algo que vai pra produção sem dor.</p>
...
<div class="callout callout-info"><div class="callout-title">Por que separar build do listen?</div><div>Permite escrever testes que constroem a instância e usam <code>app.inject()</code> sem subir socket. Mais rápido e estável que subir HTTP de verdade.</div></div>`}})]})}export{i as default};
