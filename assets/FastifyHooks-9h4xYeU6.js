...
<div class="callout callout-warn"><div class="callout-title">Cuidado com onSend</div><div>O payload chega serializado (string/Buffer). Para mexer no objeto, use <code>preSerialization</code>.</div></div>`}})]})}export{d as default};
