import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Introdução · iniciante · 14 min"}),e.jsx("h1",{children:"O Event Loop"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>O event loop é o coração do Node. Ele orquestra <strong>callbacks</strong>, <strong>promises</strong> e <strong>I/O</strong> sem bloquear a thread principal de JavaScript. Entender suas fases é o que separa quem escreve Node por instinto de quem realmente prevê quando algo vai travar a aplicação.</p>
...
<div class="callout callout-tip"><div class="callout-title">Diagnóstico</div><div>Use <code>node --trace-event-categories=node.async_hooks</code> ou ferramentas como <code>clinic doctor</code> para visualizar bloqueios no loop. <code>perf_hooks.monitorEventLoopDelay()</code> dá métricas em produção.</div></div>`}})]})}export{r as default};
