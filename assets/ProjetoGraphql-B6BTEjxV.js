import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function o(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Projetos · avancado · 11 min"}),e.jsx("h1",{children:"Projeto: GraphQL"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>API GraphQL com <strong>graphql-yoga</strong>, schema-first, resolvers, DataLoader para resolver N+1, autenticação por JWT no contexto e subscriptions via SSE. Backend usando Prisma + Postgres.</p>
...
<div class="callout callout-tip"><div class="callout-title">Tipos do schema</div><div>Use <code>graphql-codegen</code> para gerar tipos TS dos resolvers e do client — elimina drift entre schema e código.</div></div>`}})]})}export{o as default};
