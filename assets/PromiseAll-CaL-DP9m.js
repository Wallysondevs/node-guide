import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function s(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Async · intermediario · 9 min"}),e.jsx("h1",{children:"Promise.all/race/any/allSettled"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Os combinadores de promise (<code>all</code>, <code>allSettled</code>, <code>race</code>, <code>any</code>) deixam você compor operações assíncronas em paralelo com semânticas diferentes de sucesso/falha. Escolher o combinador errado é uma das fontes mais comuns de bugs em Node.</p>
...
<div class="callout callout-tip"><div class="callout-title">AggregateError</div><div><code>Promise.any</code> rejeita com <code>AggregateError</code> contendo <code>.errors[]</code> com todas as causas — útil para logar tudo o que falhou.</div></div>`}})]})}export{s as default};
