import{j as o}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return o.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[o.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Módulos · iniciante · 9 min"}),o.jsx("h1",{children:"ES Modules (import/export)"}),o.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><strong>ES Modules</strong> (ESM) é o sistema oficial de módulos do JavaScript, padronizado pela ECMAScript. Roda nativamente em browsers e em Node 14+. Em projetos novos é o default — ative com <code>&quot;type&quot;: &quot;module&quot;</code> no <code>package.json</code> ou use a extensão <code>.mjs</code>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Migração gradual</div><div>Você pode ter um pacote CJS e arquivos ESM com extensão <code>.mjs</code> (ou vice-versa com <code>.cjs</code>). Útil em monorepos legacy.</div></div>`}})]})}export{r as default};
