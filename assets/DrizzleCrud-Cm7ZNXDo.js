import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Banco de dados · intermediario · 9 min"}),e.jsx("h1",{children:"Drizzle: queries"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Com o schema definido (ver capítulo de setup), o Drizzle expõe um query builder que parece SQL mas é totalmente tipado: o TS sabe quais colunas existem, seus tipos e o que cada operador retorna.</p>
...
<div class="callout callout-tip"><div class="callout-title">Logs de SQL</div><div>Passe <code>{ logger: true }</code> em <code>drizzle(pool, { logger: true })</code> para ver as queries no console durante o dev.</div></div>`}})]})}export{r as default};
