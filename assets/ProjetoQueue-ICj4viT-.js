import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function d(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Projetos · avancado · 11 min"}),e.jsx("h1",{children:"Projeto: queue worker"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Sistema de jobs assíncronos com <strong>BullMQ</strong> sobre Redis: producer, worker, retries com backoff exponencial, jobs agendados (cron), prioridade e dashboard com bull-board.</p>
...
<div class="callout callout-tip"><div class="callout-title">Quando NÃO usar BullMQ</div><div>Para jobs distribuídos entre linguagens diferentes ou com requisitos rígidos de delivery, prefira RabbitMQ ou Kafka. BullMQ é Node-only e roda sobre Redis Lists/Streams.</div></div>`}})]})}export{d as default};
