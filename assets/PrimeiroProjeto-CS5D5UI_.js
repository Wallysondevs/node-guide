import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function s(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Introdução · iniciante · 10 min"}),e.jsx("h1",{children:"Primeiro projeto"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Vamos criar um servidor HTTP mínimo, sem dependências externas. Só Node puro. O objetivo é entender a estrutura básica de um projeto antes de adicionar Express/Fastify.</p>
...
<div class="callout callout-tip"><div class="callout-title">Próximos passos</div><div>Esse é o "hello world" cru. Em projetos reais você usa <strong>Express</strong> ou <strong>Fastify</strong> para roteamento, middleware, parsing de body e validação.</div></div>`}})]})}export{s as default};
