import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"API design · iniciante · 8 min"}),e.jsx("h1",{children:"Design REST"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>REST não é "qualquer API HTTP que retorna JSON". É um conjunto de convenções que torna sua API previsível, cacheável e fácil de consumir. Investir em design consistente economiza dezenas de horas no longo prazo.</p>
...
<div class="callout callout-warn"><div class="callout-title">Não vaze IDs internos</div><div>Use UUIDs ou IDs externos opacos quando o recurso for público. IDs sequenciais expõem volumetria do negócio e facilitam enumeração.</div></div>`}})]})}export{i as default};
