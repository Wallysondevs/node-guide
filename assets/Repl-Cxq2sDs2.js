import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Introdução · iniciante · 6 min"}),e.jsx("h1",{children:"REPL e flags úteis"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>O <strong>REPL</strong> (Read-Eval-Print Loop) é o prompt interativo do Node. Ótimo para experimentar APIs, depurar regex, inspecionar objetos e prototipar trechos antes de comitá-los a um arquivo.</p>
...
<div class="callout callout-info"><div class="callout-title">Node 22 e .ts nativo</div><div>Com <code>--experimental-strip-types</code> o Node remove anotações de tipo em runtime e executa o arquivo. Não faz checagem — para isso continua sendo <code>tsc --noEmit</code> no CI.</div></div>`}})]})}export{r as default};
