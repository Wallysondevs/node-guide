import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Fastify · intermediario · 7 min"}),e.jsx("h1",{children:"Performance e produção"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Fastify é rápido por padrão, mas há um conjunto de práticas que separam um app "ok" de um que aguenta dezenas de milhares de req/s sem ranger. Schemas, logger certo e ordem de inicialização fazem a diferença.</p>
...
<div class="callout callout-warn"><div class="callout-title">Memória vs throughput</div><div>Schemas geram código JIT — apps com milhares de rotas distintas podem aumentar uso de memória. Monitore.</div></div>`}})]})}export{r as default};
