import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function d(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Build & TS · intermediario · 7 min"}),e.jsx("h1",{children:"esbuild"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><strong>esbuild</strong> é um bundler/transpiler escrito em Go. Compila TypeScript e JSX, faz bundling, minificação, tree-shaking e splitting — tudo entre 10x e 100x mais rápido que webpack/Rollup. Em servidores Node, é a opção mais simples para gerar um <code>dist/</code> pronto para deploy.</p>
...
<div class="callout callout-tip"><div class="callout-title">tsup como wrapper</div><div>Para libs publicáveis, <code>tsup</code> usa esbuild por baixo + adiciona geração de <code>.d.ts</code>, dual ESM/CJS e configuração mais simples.</div></div>`}})]})}export{d as default};
