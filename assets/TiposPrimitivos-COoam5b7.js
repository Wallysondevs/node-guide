...
<div class="callout callout-tip"><div class="callout-title">TypeScript ajuda muito aqui</div><div>Boa parte das pegadinhas (coerção, ausência de propriedade, NaN) somem ou viram erro de compilação com TS estrito (<code>strictNullChecks</code>, <code>noImplicitAny</code>).</div></div>`}})]})}export{r as default};
