import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Testing · intermediario · 8 min"}),e.jsx("h1",{children:"Jest"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Jest é o test runner historicamente mais popular no ecossistema JS. Vem completo: assertions, mocks, snapshot, coverage, watch. Lento comparado a Vitest mas tem suporte excelente em CI e tooling enterprise.</p>
...
<div class="callout callout-tip"><div class="callout-title">Para Node puro, considere node:test</div><div>Desde Node 20, há test runner nativo. Sem instalar nada, sem config. Bom para libs e scripts.</div></div>`}})]})}export{i as default};
