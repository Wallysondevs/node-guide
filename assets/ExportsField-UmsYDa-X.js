import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Módulos · intermediario · 10 min"}),e.jsx("h1",{children:"Exports field"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>O campo <code>exports</code> no <code>package.json</code> é o mecanismo moderno para expor entrypoints de um pacote. Ele substitui (e estende) <code>main</code>, dando controle fino sobre ESM vs CJS, types do TypeScript e ambiente (browser, node, deno).</p>
...
<div class="callout callout-tip"><div class="callout-title">Ferramenta</div><div><code>tsup</code> e <code>tshy</code> geram automaticamente o campo <code>exports</code> coerente com a saída dual. Use <code>npx @arethetypeswrong/cli</code> antes de publicar para validar todas as condições contra Node ESM, Node CJS e bundlers.</div></div>`}})]})}export{t as default};
