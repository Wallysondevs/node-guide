import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function s(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Banco de dados · intermediario · 9 min"}),e.jsx("h1",{children:"Drizzle: setup"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><strong>Drizzle</strong> é um ORM &quot;SQL-like&quot; tipado para TypeScript. Em vez de esconder SQL atrás de abstrações, ele tipa o que você já escreveria — sem runtime grande, sem geração de cliente. Roda em Node, Bun, Deno, edge runtimes (Cloudflare, Vercel) e suporta Postgres, MySQL e SQLite.</p>
...
<div class="callout callout-tip"><div class="callout-title">Postgres no Replit</div><div>Provisione <code>DATABASE_URL</code> via Replit DB ou Neon — Drizzle funciona com qualquer connection string Postgres padrão.</div></div>`}})]})}export{s as default};
