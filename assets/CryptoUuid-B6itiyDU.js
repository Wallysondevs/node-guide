...
<div class="callout callout-tip"><div class="callout-title">UUID v7 com biblioteca</div><div>Se precisa de UUIDs ordenáveis (melhores índices), use <code>uuid</code> npm com <code>v7()</code> ou <code>ulid</code>.</div></div>`}})]})}export{i as default};
