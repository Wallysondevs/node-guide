import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function s(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Banco de dados · intermediario · 8 min"}),e.jsx("h1",{children:"PostgreSQL com pg"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>O pacote <code>pg</code> é o driver oficial do PostgreSQL para Node. Sem ORM no caminho: você escreve SQL puro e tem controle total. Em produção, sempre via <strong>connection pool</strong>.</p>
...
<div class="callout callout-tip"><div class="callout-title">Alternativa</div><div>O pacote <code>postgres</code> (porsager) oferece API mais ergonômica, suporte a tagged templates seguros, e melhor performance. Vale considerar.</div></div>`}})]})}export{s as default};
