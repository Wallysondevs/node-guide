...
<div class="callout callout-tip"><div class="callout-title">Shebang</div><div>Para tornar o script executável direto: comece com <code>#!/usr/bin/env node</code>, dê <code>chmod +x</code> e adicione em <code>"bin"</code> no package.json.</div></div>`}})]})}export{t as default};
