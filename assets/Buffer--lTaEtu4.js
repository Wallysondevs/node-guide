import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Streams & Buffers · intermediario · 8 min"}),e.jsx("h1",{children:"Buffer"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><code>Buffer</code> é a representação de dados binários em Node — uma fatia de memória <em>fora do heap V8</em>. É um <code>Uint8Array</code> com helpers para encoding, slicing e I/O. Sempre que você lê arquivo, recebe pacote TCP ou usa crypto, está manipulando Buffers.</p>
...
<div class="callout callout-warn"><div class="callout-title">Concatenar com +</div><div>Não use <code>buf1 + buf2</code> — vira string via <code>toString()</code>. Use <code>Buffer.concat([b1, b2])</code>.</div></div>`}})]})}export{t as default};
