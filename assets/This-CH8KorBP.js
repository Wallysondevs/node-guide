import{j as o}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return o.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[o.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Fundamentos JS · intermediario · 8 min"}),o.jsx("h1",{children:"this, bind, call e apply"}),o.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><code>this</code> é a palavrinha que mais derruba código JS. Em funções regulares, ele é definido <strong>no momento da chamada</strong> — não onde foi declarado. Em arrow functions é lexical (herdado do escopo). Entender isso evita 90% dos bugs de "undefined is not a function".</p>
...
<div class="callout callout-warn"><div class="callout-title">new sem new</div><div>Chamar um construtor sem <code>new</code> em strict mode dá <code>TypeError</code>. Em sloppy, polui o objeto global. Sempre marque construtores com nome PascalCase e prefira <code>class</code>.</div></div>`}})]})}export{i as default};
