import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function a(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Testing · intermediario · 8 min"}),e.jsx("h1",{children:"Coverage e CI"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Cobertura de testes responde uma pergunta: <strong>quais linhas/branches do código foram exercitadas pelos testes?</strong>. É um sinal — não uma meta sagrada. Use para encontrar áreas críticas sem teste, não para perseguir 100%.</p>
...
<div class="callout callout-tip"><div class="callout-title">Foco em fluxos críticos</div><div>Em vez de subir &quot;cobertura geral&quot;, escolha 3-5 fluxos críticos (login, checkout, webhook) e exija &gt;90% só nesses arquivos via <code>thresholds.perFile</code>.</div></div>`}})]})}export{a as default};
