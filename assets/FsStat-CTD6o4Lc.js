import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"fs · iniciante · 6 min"}),e.jsx("h1",{children:"Stat, exists e tipo"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Antes de ler, mover ou deletar um arquivo é comum precisar saber se ele existe, seu tamanho, mtime ou se é diretório/symlink. Use <code>stat</code> e <code>access</code> de <code>node:fs/promises</code>.</p>
...
<div class="callout callout-info"><div class="callout-title">Códigos comuns</div><div><code>ENOENT</code> (não existe), <code>EACCES</code> (sem permissão), <code>EISDIR</code> (esperava arquivo), <code>ENOTDIR</code> (esperava diretório).</div></div>`}})]})}export{t as default};
