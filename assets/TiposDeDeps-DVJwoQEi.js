import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function n(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Módulos · iniciante · 7 min"}),e.jsx("h1",{children:"dependencies vs dev vs peer"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>O <code>package.json</code> tem quatro campos para dependências, cada um com semântica e impacto diferente em quem instala seu pacote. Misturá-los gera builds gordas em produção, pacotes quebrados para usuários e atualizações dolorosas.</p>
...
<div class="callout callout-warn"><div class="callout-title">Cuidado com bundlephobia</div><div>Toda dependência em <code>dependencies</code> conta para o tamanho final em ambientes serverless. Importe só o que usa, prefira libs pequenas e verifique <code>bundlephobia.com</code> antes de adicionar.</div></div>`}})]})}export{n as default};
