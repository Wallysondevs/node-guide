import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Deploy · intermediario · 7 min"}),e.jsx("h1",{children:"Healthchecks"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Healthchecks são endpoints que orquestradores (Kubernetes, ECS, Docker Swarm) e load balancers consultam para decidir se reiniciam o container ou se direcionam tráfego. Sem eles, deploys quebram silenciosamente.</p>
...
<div class="callout callout-tip"><div class="callout-title">Use terminus</div><div>O pacote <code>@godaddy/terminus</code> empacota graceful shutdown + healthcheck com boas práticas.</div></div>`}})]})}export{t as default};
