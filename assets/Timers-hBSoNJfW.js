import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Async · iniciante · 7 min"}),e.jsx("h1",{children:"setTimeout, setInterval, setImmediate"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Os timers do Node agendam funções para o event loop. Conhecer a diferença entre <code>setTimeout</code>, <code>setInterval</code>, <code>setImmediate</code> e <code>process.nextTick</code> é o que separa código que "funciona" do código que escala.</p>
