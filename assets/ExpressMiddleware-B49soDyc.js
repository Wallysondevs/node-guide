import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Express · iniciante · 11 min"}),e.jsx("h1",{children:"Middleware"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Middleware é uma função com assinatura <code>(req, res, next)</code> que roda na ordem em que é registrada. É o conceito central do Express — autenticação, logs, parsing, rate limit, tudo é middleware.</p>
...
<div class="callout callout-tip"><div class="callout-title">Composição</div><div>Para reusar várias linhas de pipeline, exporte arrays: <code>export const protectedRoute = [auth(), rateLimit(), audit()]</code> e use <code>app.get('/x', ...protectedRoute, handler)</code>.</div></div>`}})]})}export{t as default};
