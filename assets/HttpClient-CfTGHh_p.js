import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function c(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"HTTP nativo · iniciante · 8 min"}),e.jsx("h1",{children:"HTTP client (fetch)"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Node 18+ traz <code>fetch</code> nativo (baseado em <strong>undici</strong>), com a mesma API do browser. Para 95% dos casos, você não precisa mais de <code>axios</code>, <code>node-fetch</code> ou <code>got</code>.</p>
...
<div class="callout callout-info"><div class="callout-title">Retry exponencial</div><div>Combine com <code>AbortSignal.timeout</code> e backoff: 200ms, 400ms, 800ms. Pare em 4xx (cliente) — só retry 5xx e network errors.</div></div>`}})]})}export{c as default};
