import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Eventos · intermediario · 8 min"}),e.jsx("h1",{children:"AbortController"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><code>AbortController</code> é a API padrão (Web + Node) para sinalizar cancelamento de operações assíncronas. Substitui flags manuais, <em>cancellation tokens</em> caseiros e timers acoplados.</p>
...
<div class="callout callout-warn"><div class="callout-title">Memory leak silencioso</div><div>Se você adiciona muitos listeners ao mesmo <code>signal</code> sem removê-los (ou sem usar <code>{ once: true }</code>), o Node avisa em <code>MaxListenersExceededWarning</code>. Em produção isso causa retenção de objetos.</div></div>`}})]})}export{t as default};
