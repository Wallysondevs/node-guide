import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Segurança · intermediario · 8 min"}),e.jsx("h1",{children:"Rate limit avançado e secrets"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Rate limiting protege sua API contra abuso, brute-force e custo descontrolado. Em produção, o limit precisa ser <strong>distribuído</strong> (vários processos compartilhando estado) e os <strong>segredos</strong> nunca devem viver no repositório nem em variáveis chumbadas.</p>
...
<div class="callout callout-warn"><div class="callout-title">Não logue o segredo</div><div>Configure o logger para redacta campos sensíveis. <code>pino</code> tem <code>redact: ['req.headers.authorization', '*.password']</code>. Um stack trace vazado em Sentry com a env inteira é incidente de segurança.</div></div>`}})]})}export{i as default};
