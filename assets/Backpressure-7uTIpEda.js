import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Streams & Buffers · avancado · 9 min"}),e.jsx("h1",{children:"Backpressure"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Quando o produtor é mais rápido que o consumidor, dados se acumulam em buffers internos — memória explode. <strong>Backpressure</strong> é o mecanismo de empurrar de volta o sinal "vai devagar" até a fonte original. Ignorar isso é a causa #1 de OOM em pipelines Node.</p>
...
<div class="callout callout-warn"><div class="callout-title">Sintoma de backpressure ignorado</div><div>RSS subindo monotônicamente em transferências, sem GC liberar. Investigue com <code>process.memoryUsage()</code> e Clinic Doctor.</div></div>`}})]})}export{i as default};
