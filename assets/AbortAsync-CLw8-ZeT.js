import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Async · intermediario · 8 min"}),e.jsx("h1",{children:"Cancelando async"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Operações assíncronas que nunca terminam consomem memória, sockets e file descriptors. <strong>Cancelar</strong> é tão importante quanto iniciar. Em Node 18+ a forma idiomática é combinar <code>AbortController</code> com APIs que aceitam <code>signal</code>.</p>
...
<div class="callout callout-warn"><div class="callout-title">Streams travadas</div><div>Se você não passa o signal para um <code>Readable</code> infinito, o processo nunca encerra. Sempre encadeie via <code>pipeline(src, dst, { signal })</code>.</div></div>`}})]})}export{i as default};
