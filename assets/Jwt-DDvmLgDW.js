import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Auth · intermediario · 9 min"}),e.jsx("h1",{children:"JWT (JSON Web Tokens)"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>JWT é um formato compacto de token: header + payload + signature, base64url. O servidor assina; qualquer parte com a chave pública verifica sem consultar banco. Bom para auth stateless em APIs e microsserviços.</p>
...
<div class="callout callout-tip"><div class="callout-title">Em sessões com cookie, JWT é overkill</div><div>Sessão server-side com sid opaco em cookie é mais simples e mais seguro. JWT brilha quando você precisa de stateless.</div></div>`}})]})}export{i as default};
