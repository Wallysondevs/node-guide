import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function a(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Build & TS · iniciante · 7 min"}),e.jsx("h1",{children:"ESLint e Prettier"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><strong>ESLint</strong> pega bugs e impõe convenções (variável não usada, await em loop, comparação errada). <strong>Prettier</strong> formata o código (espaços, quebras, aspas). Juntos, padronizam o estilo do time e eliminam discussão em PR.</p>
...
<div class="callout callout-info"><div class="callout-title">Biome é alternativa</div><div>Biome unifica linter+formatter em um binário Rust ultra-rápido. API ainda em evolução, mas vale acompanhar.</div></div>`}})]})}export{a as default};
