import{j as a}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return a.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[a.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Auth · intermediario · 7 min"}),a.jsx("h1",{children:"Senhas com bcrypt"}),a.jsx("div",{dangerouslySetInnerHTML:{__html:`<p><code>bcrypt</code> é um <em>password hash</em> propositadamente lento, com <em>salt</em> embutido e <em>cost factor</em> ajustável. É a baseline mínima para guardar senhas em qualquer aplicação web.</p>
...
<div class="callout callout-tip"><div class="callout-title">Argon2id</div><div><code>npm i argon2</code>. API parecida, mas mais resistente a ASIC/GPU. Recomendado pela OWASP em projetos novos.</div></div>`}})]})}export{r as default};
