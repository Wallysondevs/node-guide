import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function r(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Fastify · intermediario · 8 min"}),e.jsx("h1",{children:"Plugins"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>No Fastify, <strong>tudo é plugin</strong>: rotas, hooks, decorators, integrações. Plugins são a unidade fundamental de organização e o segredo do encapsulamento que torna o framework previsível em projetos grandes.</p>
...
<div class="callout callout-tip"><div class="callout-title">Testes</div><div>Como cada plugin é uma função pura sobre uma instância, você pode subir uma <code>Fastify()</code> só com o plugin sob teste — sem mocks complicados.</div></div>`}})]})}export{r as default};
