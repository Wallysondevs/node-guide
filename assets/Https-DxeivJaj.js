import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"HTTP nativo · intermediario · 7 min"}),e.jsx("h1",{children:"HTTPS e certificados"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>HTTPS é HTTP sobre TLS. Em produção, normalmente você termina TLS no proxy (nginx, Caddy, Cloudflare, ALB) e o Node escuta HTTP plano internamente. Para dev local, mTLS, ou quando o serviço é exposto direto, você precisa configurar TLS no Node.</p>
...
<div class="callout callout-warn"><div class="callout-title">rejectUnauthorized=false só em dev</div><div>Desativar validação de cert no cliente abre brecha para MITM. Em produção, importe a CA correta.</div></div>`}})]})}export{t as default};
