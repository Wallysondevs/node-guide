import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function i(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"fs · intermediario · 9 min"}),e.jsx("h1",{children:"Streams de arquivo"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Streams permitem processar arquivos pedaço por pedaço, mantendo o uso de memória constante (tipicamente 64KB de buffer) independente do tamanho do arquivo. Essencial para logs, vídeos, dumps de banco e qualquer coisa acima de algumas dezenas de MB.</p>
...
<div class="callout callout-info"><div class="callout-title">Web Streams</div><div>Node 18+ suporta <code>ReadableStream</code> da spec Web. <code>Readable.toWeb()</code> converte. Útil quando o consumidor é fetch ou Response.</div></div>`}})]})}export{i as default};
