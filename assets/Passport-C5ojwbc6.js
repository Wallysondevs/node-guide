...
<div class="callout callout-warn"><div class="callout-title">Cuidado com cookies</div><div>Em produção, use <code>cookie: { secure: true, httpOnly: true, sameSite: 'lax' }</code> e configure <code>trust proxy</code> se estiver atrás de load balancer.</div></div>`}})]})}export{t as default};
