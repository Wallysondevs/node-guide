import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Fastify · intermediario · 6 min"}),e.jsx("h1",{children:"Decorators"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Decorators são o mecanismo do Fastify para anexar propriedades e métodos à instância, ao <code>request</code> ou ao <code>reply</code>. É como você compartilha utilitários (banco, logger, helpers) sem singletons globais e mantendo o tipo conhecido.</p>
...
<div class="callout callout-info"><div class="callout-title">Performance</div><div>Inicializar campos com <code>null</code> em vez de <code>undefined</code> evita transições de hidden class no V8 e mantém o request rápido.</div></div>`}})]})}export{t as default};
