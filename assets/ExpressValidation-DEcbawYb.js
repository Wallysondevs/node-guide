import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function t(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Express · intermediario · 9 min"}),e.jsx("h1",{children:"Validação com Zod"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Validar entrada é a primeira linha de defesa de qualquer API. <strong>Zod</strong> oferece schemas declarativos com inferência de tipos em TypeScript, o que elimina a duplicação entre validação em runtime e tipagem estática.</p>
...
<div class="callout callout-warn"><div class="callout-title">Não confie no cliente</div><div>Mesmo com validação no front, valide de novo no back. O cliente pode ser modificado, scripts podem chamar sua API direto.</div></div>`}})]})}export{t as default};
