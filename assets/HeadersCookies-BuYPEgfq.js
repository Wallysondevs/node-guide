import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function a(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"HTTP nativo · intermediario · 7 min"}),e.jsx("h1",{children:"Headers e cookies"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Headers carregam metadados de cada request/response: tipo de conteúdo, cache, autenticação, idioma. Cookies são pares chave/valor enviados via header <code>Cookie</code> e setados via <code>Set-Cookie</code>. Dominar isso é pré-requisito para auth, sessões, CORS e cache.</p>
...
<div class="callout callout-tip"><div class="callout-title">Em Express, use cookie-parser</div><div>O módulo <code>cookie</code> (npm) faz parse/serialize com escape correto. Não invente seu próprio em produção.</div></div>`}})]})}export{a as default};
