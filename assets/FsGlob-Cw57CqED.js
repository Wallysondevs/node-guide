import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function l(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"fs · intermediario · 7 min"}),e.jsx("h1",{children:"Glob e walk"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Listar arquivos por padrão (<em>glob</em>) é comum em CLIs, build tools e scripts. Node 22+ traz um <code>glob</code> nativo; em versões anteriores, <code>fast-glob</code> é o padrão. Para casos simples, basta caminhar o diretório com <code>readdir</code>.</p>
...
<div class="callout callout-info"><div class="callout-title">.gitignore aware</div><div>Use <code>globby</code> com <code>{ gitignore: true }</code> para respeitar arquivos ignorados pelo Git automaticamente.</div></div>`}})]})}export{l as default};
