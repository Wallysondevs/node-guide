import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function c(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Módulos · avancado · 10 min"}),e.jsx("h1",{children:"Dual ESM + CJS"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Publicar uma biblioteca para ser consumida por <strong>ambos</strong> CJS (<code>require</code>) e ESM (<code>import</code>) requer construir os dois formatos e expor cada um com <code>exports</code> condicionais. É um trade-off: maior compatibilidade vs risco do &quot;dual package hazard&quot;.</p>
...
<div class="callout callout-tip"><div class="callout-title">Verifique antes de publicar</div><div>Use <code>npx @arethetypeswrong/cli .</code> e <code>publint</code> para auditar o <code>package.json</code> e detectar problemas comuns de dual publishing.</div></div>`}})]})}export{c as default};
