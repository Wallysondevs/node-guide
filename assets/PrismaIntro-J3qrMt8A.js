import{j as e}from"./index-DA-7IjJ5.js";import"./router-C1uOM3Rc.js";import"./vendor-t4EjNNdb.js";import"./icons-CF3mSuKt.js";function s(){return e.jsxs("article",{className:"chapter max-w-3xl mx-auto px-6 py-10",children:[e.jsx("div",{className:"text-xs text-muted-foreground mb-2 font-mono",children:"Banco de dados · intermediario · 9 min"}),e.jsx("h1",{children:"Prisma: schema e migrate"}),e.jsx("div",{dangerouslySetInnerHTML:{__html:`<p>Prisma é um ORM moderno para Node/TypeScript com <strong>geração automática de tipos</strong>, migrations versionadas e um schema declarativo próprio (DSL chamada Prisma Schema Language).</p>
...
<div class="callout callout-tip"><div class="callout-title">Versionamento</div><div>Commit <code>prisma/migrations/</code> SEMPRE. Ele é a fonte da verdade do schema do banco em produção.</div></div>`}})]})}export{s as default};
